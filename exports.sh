...
:/media/data1/installs/4linux/node-v20.11.0-linux-x64/bin\
:/opt/lampp/bin:$GOPATH/bin:/d/bins/installs/windows/scrcpy-win64-v1.16"
# :/media/data1/installs/4linux/node-v18.15.0-linux-x64/bin
